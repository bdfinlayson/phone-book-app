...
$('tbody').on('click', '.enlarge', function(event) {
  var enlargeImg = $(event.target).closest('img');
  enlargeImg.animate({
    width: '300px'
  }, 3500 );
});
